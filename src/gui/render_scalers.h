...
extern System::Byte Scaler_Aspect[];
extern System::Byte diff_table[];
extern unsigned Scaler_ChangedLineIndex;
extern System::UInt16 Scaler_ChangedLines[];
#if RENDER_USE_ADVANCED_SCALERS>1
/* Not entirely happy about those +2's since they make a non power of 2, with muls instead of shift */
typedef System::Byte scalerChangeCache_t [SCALER_COMPLEXHEIGHT][SCALER_COMPLEXWIDTH / SCALER_BLOCKSIZE] ;
typedef union {
	System::UInt32 b32	[SCALER_COMPLEXHEIGHT] [SCALER_COMPLEXWIDTH];
	System::UInt16 b16	[SCALER_COMPLEXHEIGHT] [SCALER_COMPLEXWIDTH];
	System::Byte b8	[SCALER_COMPLEXHEIGHT] [SCALER_COMPLEXWIDTH];
} scalerFrameCache_t;
#endif
typedef union {
	System::UInt32 b32	[SCALER_MAXHEIGHT] [SCALER_MAXWIDTH];
	System::UInt16 b16	[SCALER_MAXHEIGHT] [SCALER_MAXWIDTH];
	System::Byte b8	[SCALER_MAXHEIGHT] [SCALER_MAXWIDTH];
} scalerSourceCache_t;
