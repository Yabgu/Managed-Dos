...
#define LoadMbs(off) (System::SByte)(LoadMb(off))
#define LoadMws(off) (System::Int16)(LoadMw(off))
#define LoadMds(off) (System::Int32)(LoadMd(off))
...
static INLINE System::SByte Fetchbs() {
	return Fetchb();
}
static INLINE System::Int16 Fetchws() {
	return Fetchw();
}

static INLINE System::Int32 Fetchds() {
	return Fetchd();
}
