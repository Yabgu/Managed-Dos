...
unsigned read_p3c4(unsigned /*port*/,unsigned /*iolen*/) {
	return seq(index);
}

void write_p3c4(unsigned /*port*/,unsigned val,unsigned /*iolen*/) {
	seq(index)=val;
}

void write_p3c5(unsigned /*port*/,unsigned val,unsigned iolen) {
...
unsigned read_p3c5(unsigned /*port*/,unsigned iolen) {
