...
CSerialDummy::CSerialDummy(unsigned id,	CommandLine* cmd):CSerial(id, cmd) {
...
void CSerialDummy::handleUpperEvent(System::UInt16 type) {
...
/*****************************************************************************/
void CSerialDummy::updatePortConfig(System::UInt16 divider, System::Byte lcr) {
	//LOG_MSG("Serial port at 0x%x: Port params changed: %d Baud", base,dcb.BaudRate);
}

void CSerialDummy::updateMSR() {
}
void CSerialDummy::transmitByte(System::Byte val, bool first) {
