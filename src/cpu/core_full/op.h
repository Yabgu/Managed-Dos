...
/* Using the instructions.h defines */
	...
	case O_GRP6d:
		...
		case 0x00:	/* SLDT */
			inst_op1_d=(System::UInt32)CPU_SLDT();
			break;
		case 0x01:	/* STR */
			inst_op1_d=(System::UInt32)CPU_STR();
			break;
		case 0x02:	/* LLDT */
	...
	case O_LAR:
		{
			unsigned ar=inst_op2_d;
			CPU_LAR(inst_op1_w,ar);
			inst_op1_d=(System::UInt32)ar;
		}
		break;
	case O_LSL:
		{
			unsigned limit=inst_op2_d;
			CPU_LSL(inst_op1_w,limit);
			inst_op1_d=(System::UInt32)limit;
		}
		break;
	case O_ARPL:
		{
			unsigned new_sel=inst_op1_d;
			CPU_ARPL(new_sel,inst_op2_d);
			inst_op1_d=(System::UInt32)new_sel;
		}
		break;
	case O_BSFw:
		{
	...
	case O_BOUNDw:
		{
			...
			if ( (((System::Int16)inst_op1_w) < bound_min) || (((System::Int16)inst_op1_w) > bound_max) ) {
				EXCEPTION(5);
			}
		}
		break;
