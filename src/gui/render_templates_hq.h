...
static System::UInt32 *_RGBtoYUV = 0;
static inline bool diffYUV(System::UInt32 yuv1, System::UInt32 yuv2)
{
	static const System::UInt32 Ymask = 0x00FF0000;
	static const System::UInt32 Umask = 0x0000FF00;
	static const System::UInt32 Vmask = 0x000000FF;
	static const System::UInt32 trY   = 0x00300000;
	static const System::UInt32 trU   = 0x00000700;
	static const System::UInt32 trV   = 0x00000006;
...
static inline void conc2d(InitLUTs,SBPP)(void)
{
	...
	_RGBtoYUV = (System::UInt32 *)malloc(65536 * sizeof(System::UInt32));
...
#else
		r = ((color & redMask) >> redShift) << (8 - redint);
		g = ((color & greenMask) >> greenShift) << (8 - greenint);
		b = ((color & blueMask) >> blueShift) << (8 - blueint);
#endif
		Y = (r + g + b) >> 2;
		u = 128 + ((r - b) >> 2);
		v = 128 + ((-r + 2 * g - b) >> 3);
