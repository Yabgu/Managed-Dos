...
/* Byte */
		case M_Ib:
			...
			break;
		case M_Ebx:
			if (inst.rm<0xc0) inst_op1_ds=(System::SByte)LoadMb(inst.rm_eaa);
			else inst_op1_ds=(System::SByte)reg_8(inst.rm_eai);
			break;
		case M_EbIb:
			inst_op2_d=Fetchb();
		case M_Eb:
...
/* Word */
		case M_Iw:
			...
			break;
		case M_EwxGwx:
			inst_op2_ds=(System::Int16)reg_16(inst.rm_index);
			goto l_M_Ewx;
		case M_EwxIbx:
			inst_op2_ds=Fetchbs();
			goto l_M_Ewx;
...
l_M_Ewx:		
		case M_Ewx:
			if (inst.rm<0xc0) inst_op1_ds=(System::Int16)LoadMw(inst.rm_eaa);
			else inst_op1_ds=(System::Int16)reg_16(inst.rm_eai);
			break;
		case M_EwIb:
			inst_op2_d=Fetchb();
			goto l_M_Ew;
		...
		case M_EwGwt:
			...
			inst.rm_eaa+=((System::Int16)inst_op2_d >> 4) * 2;
			goto l_M_Ew;
l_M_EwGw:			
		case M_EwGw:
			inst_op2_d=reg_16(inst.rm_index);
...
/* DWord */
		case M_Id:
			...
			break;
		case M_EdxGdx:
			inst_op2_ds=(System::Int32)reg_32(inst.rm_index);
		case M_Edx:
			if (inst.rm<0xc0) inst_op1_d=(System::Int32)LoadMd(inst.rm_eaa);
			else inst_op1_d=(System::Int32)reg_32(inst.rm_eai);
			break;
		case M_EdIb:
			inst_op2_d=Fetchb();
			goto l_M_Ed;
		...
		case M_EdGdt:
			...
			inst.rm_eaa+=((System::Int32)inst_op2_d >> 5) * 4;
			goto l_M_Ed;
		case M_EdGdIb:
			inst_imm_d=Fetchb();
			goto l_M_EdGd;
...
/* Direct operations */
	...
	case D_XLAT:
		if (inst.prefix & PREFIX_SEG) {
			if (inst.prefix & PREFIX_ADDR) {
				reg_al=LoadMb(inst.seg.base+(System::UInt32)(reg_ebx+reg_al));
			} else {
				reg_al=LoadMb(inst.seg.base+(System::UInt16)(reg_bx+reg_al));
			}
		} else {
			if (inst.prefix & PREFIX_ADDR) {
				reg_al=LoadMb(SegBase(ds)+(System::UInt32)(reg_ebx+reg_al));
			} else {
				reg_al=LoadMb(SegBase(ds)+(System::UInt16)(reg_bx+reg_al));
			}
		}
		goto nextopcode;
	case D_CBW:
		reg_ax=(System::SByte)reg_al;
		goto nextopcode;
	case D_CWDE:
		reg_eax=(System::Int16)reg_ax;
		goto nextopcode;
	case D_CWD:
