...
static struct {
	unsigned ea,tmpb,tmpd,stack,shift,newesp;
} extra_regs;
...
static struct {
	unsigned callback;
	System::UInt32 readdata;
} core_dyn;

static struct {
	System::UInt32		state[32];
	FPU_P_Reg	temp,temp2;
	System::UInt32		dh_fpu_enabled;
	System::UInt32		state_used;
	System::UInt32		cw,host_cw;
	System::Byte		temp_state[128];
} dyn_dh_fpu;
