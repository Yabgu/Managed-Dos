...
unsigned vga_read_p3da(unsigned port,unsigned iolen) {
...
static void write_p3c2(unsigned port,unsigned val,unsigned iolen) {
	vga.misc_output=val;
	if (val & 0x1) {
...
static unsigned read_p3cc(unsigned port,unsigned iolen) {
	return vga.misc_output;
}

// VGA feature control register
static unsigned read_p3ca(unsigned port,unsigned iolen) {
	return 0;
}
...
static unsigned read_p3c2(unsigned port,unsigned iolen) {
	System::Byte retval=0;
