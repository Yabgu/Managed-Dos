 ...
 *  defines one pixel. int may be arranged in various common patterns.
 *
...
protected:
	...
	/// True if set int are background, false otherwise.
	const bool background_set;

	/// Number of int added to get from a column to the next column.
	const int col_step;

	/// Distance between 2 rows of a character, or 0 for variable-width rows.
	const int row_step;

	/// Distance of two characters in the bitmap in int.
