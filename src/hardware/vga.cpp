...
System::UInt32 CGA_2_Table[16];
System::UInt32 CGA_4_Table[256];
System::UInt32 CGA_4_HiRes_Table[256];
System::UInt32 CGA_16_Table[256];
System::UInt32 TXT_Font_Table[16];
System::UInt32 TXT_FG_Table[16];
System::UInt32 TXT_BG_Table[16];
System::UInt32 ExpandTable[256];
System::UInt32 Expand16Table[4][16];
System::UInt32 FillTable[16];
System::UInt32 ColorTable[16];
...
void VGA_SetCGA4Table(System::Byte val0,System::Byte val1,System::Byte val2,System::Byte val3) {
	System::Byte total[4]={ val0,val1,val2,val3};
