...
static CacheBlockDynRec * CreateCacheBlock(CodePageHandlerDynRec * codepage,PhysPt start,unsigned max_opcodes) {
	...
	decode.block->page.start=(System::UInt16)decode.page.index;
...
//		case 0x61: ARPL missing
		...
		case 0x68:
			...
			break;
		case 0x6a:
			dyn_push_byte_imm((System::SByte)decode_fetchb());
			break;
...
//		case 0xd7: XLAT missing
		...
		// 'jmp short imm8'
		case 0xeb:
			dyn_exit_link((System::SByte)decode_fetchb());
			goto finish_block;
...
finish_block:
	...
	decode.page.index--;
	decode.active_block->page.end=(System::UInt16)decode.page.index;
