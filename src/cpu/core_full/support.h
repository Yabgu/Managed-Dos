...
struct OpCode {
	System::Byte load,op,save,extra;
};
...
struct FullData {
	...
	union {
		...
		System::Int32 dwords[1];
		System::UInt16 word[2];
		System::Int16 words[2];
		System::Byte byte[4];
		System::SByte bytes[4];
		} blah1,blah2,blah_imm;
#else
	union {	
		System::Byte b;System::SByte bs;
		System::UInt16 w;System::Int16 ws;
		System::UInt32 d;System::Int32 ds;
	} op1,op2,imm;
#endif
	unsigned new_flags;
	struct {
