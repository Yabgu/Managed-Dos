...
static INLINE System::Byte Fetchb() {
	System::Byte temp=host_readb(core.cseip);
	core.cseip+=1;
	return temp;
}

static INLINE System::UInt16 Fetchw() {
	System::UInt16 temp=host_readw(core.cseip);
	core.cseip+=2;
	return temp;
}
static INLINE System::UInt32 Fetchd() {
	System::UInt32 temp=host_readd(core.cseip);
	core.cseip+=4;
	return temp;
}
...
// not really used
int CPU_Core_Simple_Trap_Run(void) {
