...
static void FPU_FADD_EA(unsigned op1) {
	FPUD_ARITH1_EA(faddp)
}

static void FPU_FDIV(unsigned op1, unsigned op2) {
	FPUD_ARITH3(fdivp)
}

static void FPU_FDIV_EA(unsigned op1) {
	FPUD_ARITH3_EA(fdivp)
}

static void FPU_FDIVR(unsigned op1, unsigned op2) {
	FPUD_ARITH3(fdivrp)
}

static void FPU_FDIVR_EA(unsigned op1) {
	FPUD_ARITH3_EA(fdivrp)
}

static void FPU_FMUL(unsigned op1, unsigned op2) {
	FPUD_ARITH1(fmulp)
}

static void FPU_FMUL_EA(unsigned op1) {
	FPUD_ARITH1_EA(fmulp)
}

static void FPU_FSUB(unsigned op1, unsigned op2) {
	FPUD_ARITH1(fsubp)
}

static void FPU_FSUB_EA(unsigned op1) {
	FPUD_ARITH1_EA(fsubp)
}

static void FPU_FSUBR(unsigned op1, unsigned op2) {
	FPUD_ARITH1(fsubrp)
}

static void FPU_FSUBR_EA(unsigned op1) {
	FPUD_ARITH1_EA(fsubrp)
}

static void FPU_FXCH(unsigned stv, unsigned other) {
...
static void FPU_FST(unsigned stv, unsigned other) {
	fpu.tags[other] = fpu.tags[stv];
...
static void FPU_FCOM(unsigned op1, unsigned op2) {
	FPUD_COMPARE(fcompp)
}

static void FPU_FCOM_EA(unsigned op1) {
	FPUD_COMPARE_EA(fcompp)
}

static void FPU_FUCOM(unsigned op1, unsigned op2) {
